...
export default function BusinessCard({ business }: { business: Business }) {
  ...
  return (
    <Link href={profilePath} className="neo-card p-4 sm:p-5 flex flex-col justify-between h-full group hover:-translate-y-1 transition-all duration-300 relative block cursor-pointer" aria-label={`View profile of ${business.name}`}>
      ...
      <div className="relative flex items-stretch gap-2.5 mt-4 pt-3.5 border-t border-gray-100">
        <a
          ...
          className="btn-primary flex-1 h-12 text-base flex items-center justify-center gap-2 px-4 min-w-0 shadow-md hover:shadow-lg z-10 pointer-events-auto"
