    ...
    <div className="neo-card p-4 sm:p-5 flex flex-col justify-between h-full group hover:-translate-y-1 transition-all duration-300 relative">
      ...
      <div className="relative flex items-stretch gap-2.5 mt-4 pt-3.5 border-t border-gray-100">
        <a
          ...
          className="btn-primary flex-1 h-11 text-sm flex items-center justify-center gap-2 px-4 min-w-0 shadow-md hover:shadow-lg z-10"
        >
        ...
        <Link
          href={profilePath}
          className="btn-secondary h-11 px-3.5 flex items-center justify-center gap-1.5 text-sm font-medium text-text-primary shrink-0 z-10"
        >
