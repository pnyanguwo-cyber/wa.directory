    ...
    <section className="mt-6 pt-5 border-t border-gray-200/60" aria-labelledby="featured-businesses-heading">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-4 gap-1">
        <div>
          ...
          <h2 id="featured-businesses-heading" className="text-xl sm:text-2xl font-bold text-text-primary tracking-tight">
            Featured Verified Businesses
          </h2>
          <p className="text-text-secondary text-xs sm:text-sm mt-0.5">Hand-picked verified shops and services ready to chat</p>
        </div>
      </div>
