...
export default function TypingHeadline() {
  ...
  return (
    <h1 className="text-3xl sm:text-5xl font-extrabold text-text-primary mb-4 tracking-tight leading-tight">
      Find any{' '}
      <span className="relative inline-block text-whatsapp-600 border-b-2 border-whatsapp-500/40 pb-0.5">
        {currentText}
        <span
          className="inline-block w-0.5 h-7 sm:h-10 ml-0.5 bg-whatsapp-500 animate-pulse align-middle"
          aria-hidden="true"
        />
      </span>{' '}
      on WhatsApp
