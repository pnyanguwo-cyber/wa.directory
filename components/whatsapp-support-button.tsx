...
export default function WhatsAppSupportButton() {
  ...
  useEffect(() => {
    ...
    const hide = setTimeout(() => setShowTip(false), 12000)
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-whatsapp-500 hover:bg-whatsapp-600 active:scale-95 shadow-[0_8px_24px_rgba(37,211,102,0.45)] flex items-center justify-center text-white transition-all duration-200 group"
      >
        <svg className="w-7 h-7 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
